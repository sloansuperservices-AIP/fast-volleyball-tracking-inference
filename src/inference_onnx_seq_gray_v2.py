...
def run_tracking(
    ...
    only_csv: bool = False,
    confidence_threshold: float = DEFAULT_HEATMAP_THRESHOLD,
    verbose: bool = False
):
    ...
    frame_buffer = []
    track_state = BallTrackState(maxlen=track_length, max_missing=track_length)
    frame_index = 0
    ...
    try:
        while not stop_event.is_set():
            ...
            predictions = decode_predictions(output, model_params, confidence_threshold)
