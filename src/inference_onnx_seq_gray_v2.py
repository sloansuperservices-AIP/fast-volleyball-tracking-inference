...
def _update_ld_library_path():
    """Helper to locate CUDA libraries in the environment."""
    paths = site.getsitepackages()
    for p in paths:
        cuda_path = os.path.join(p, "nvidia", "cublas", "lib")
...
def is_headless() -> bool:
    """Returns True if the environment is headless (no display)."""
...
def main():
    ...
    visualization_enabled = initialize_visualization(args.visualize and not is_headless())
    size_state = {
