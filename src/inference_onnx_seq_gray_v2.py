...
def _update_ld_library_path():
    """
    Finds nvidia cuda libraries in site-packages and appends them to LD_LIBRARY_PATH.
    This is required for onnxruntime-gpu to find the libraries when installed via uv/pip.
    """
    ...
    if cuda_libs_found:
        LOG.debug("Updated LD_LIBRARY_PATH with NVIDIA CUDA libraries.")
...
try:
    ...
    # preload_dlls is not available in all ORT versions
    pass
