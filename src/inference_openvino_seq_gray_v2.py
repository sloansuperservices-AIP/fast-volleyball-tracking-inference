...
def parse_args():
    ...
    parser.add_argument("--threshold", type=float, default=DEFAULT_HEATMAP_THRESHOLD, help="Confidence threshold")
        ...
        while cap.isOpened():
            ...
            for local_index, (frame_item, prediction) in enumerate(zip(current_frames, predictions)):
                ...
                visualization_enabled = render_prediction(
                    frame_item, visibility, x_orig, y_orig, radius, contour, writer, visualization_enabled, track
                )
